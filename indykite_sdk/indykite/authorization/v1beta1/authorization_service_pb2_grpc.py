...
from indykite_sdk.indykite.authorization.v1beta1 import (
    authorization_service_pb2 as indykite_dot_authorization_dot_v1beta1_dot_authorization__service__pb2,
)


class AuthorizationAPIStub:
...
class AuthorizationAPIServicer:
    """AuthorizationAPI represents the service interface for authorization.
    Validation fails if a request contains an unknown field.
    """
...
def add_AuthorizationAPIServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
        "indykite.authorization.v1beta1.AuthorizationAPI",
        rpc_method_handlers,
    )
