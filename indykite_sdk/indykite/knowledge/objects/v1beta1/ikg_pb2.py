...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _USER_EXTERNALID.fields_by_name['type']._options = None
  _USER_EXTERNALID.fields_by_name['type']._serialized_options = b'\372B\021r\017\030@2\013^[a-zA-Z]*$'
  _USER_EXTERNALID.fields_by_name['external_id']._options = None
  _USER_EXTERNALID.fields_by_name['external_id']._serialized_options = b'\372B\004r\002\020\001'
  _USER_PROPERTY.fields_by_name['type']._options = None
  _USER_PROPERTY.fields_by_name['type']._serialized_options = b'\372B\006r\004\020\002\030\024'
  _USER_PROPERTY.fields_by_name['value']._options = None
  _USER_PROPERTY.fields_by_name['value']._serialized_options = b'\372B\005\212\001\002\020\001'
  _USER.oneofs_by_name['user']._options = None
  _USER.oneofs_by_name['user']._serialized_options = b'\370B\001'
  _USER.fields_by_name['user_id']._options = None
  _USER.fields_by_name['user_id']._serialized_options = b'\372B!r\037\020\026\030\376\0012\030^[A-Za-z0-9-_:]{22,254}$'
  _USER.fields_by_name['property']._options = None
  _USER.fields_by_name['property']._serialized_options = b'\372B\005\212\001\002\020\001'
  _USER.fields_by_name['external_id']._options = None
  _USER.fields_by_name['external_id']._serialized_options = b'\372B\005\212\001\002\020\001'
  ...
  _globals['_PROPERTY']._serialized_start=1074
  _globals['_PROPERTY']._serialized_end=1269
  _globals['_METADATA']._serialized_start=1272
  _globals['_METADATA']._serialized_end=1652
  _globals['_METADATA_CUSTOMMETADATAENTRY']._serialized_start=1554
  _globals['_METADATA_CUSTOMMETADATAENTRY']._serialized_end=1652
  _globals['_USER']._serialized_start=1655
  _globals['_USER']._serialized_end=2134
  _globals['_USER_EXTERNALID']._serialized_start=1917
  _globals['_USER_EXTERNALID']._serialized_end=2013
  _globals['_USER_PROPERTY']._serialized_start=2015
  _globals['_USER_PROPERTY']._serialized_end=2121
