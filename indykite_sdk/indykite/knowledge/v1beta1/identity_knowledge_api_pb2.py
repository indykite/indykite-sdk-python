...
from indykite_sdk.indykite_sdk.indykite_sdk.indykite_sdk.indykite_sdk.indykite_sdk.indykite_sdk.indykite_sdk.indykite.knowledge.v1beta1 import model_pb2 as indykite_dot_knowledge_dot_v1beta1_dot_model__pb2
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_IDENTITYKNOWLEDGEREQUEST_INPUTPARAMSENTRY']._loaded_options = None
  _globals['_IDENTITYKNOWLEDGEREQUEST_INPUTPARAMSENTRY']._serialized_options = b'8\001'
  _globals['_IDENTITYKNOWLEDGEREQUEST'].fields_by_name['operation']._loaded_options = None
  _globals['_IDENTITYKNOWLEDGEREQUEST'].fields_by_name['operation']._serialized_options = b'\372B\007\202\001\004\020\001\030\001'
  _globals['_IDENTITYKNOWLEDGEREQUEST'].fields_by_name['path']._loaded_options = None
  _globals['_IDENTITYKNOWLEDGEREQUEST'].fields_by_name['path']._serialized_options = b'\372B\006r\004(\200\240\037'
  _globals['_IDENTITYKNOWLEDGEREQUEST'].fields_by_name['conditions']._loaded_options = None
  _globals['_IDENTITYKNOWLEDGEREQUEST'].fields_by_name['conditions']._serialized_options = b'\372B\006r\004(\200\240\037'
