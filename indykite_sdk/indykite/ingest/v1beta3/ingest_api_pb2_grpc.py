...
def add_IngestAPIServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler("indykite.ingest.v1beta3.IngestAPI", rpc_method_handlers)
...
class IngestAPI:
    ...
    @staticmethod
    def BatchDeleteRelationshipProperties(
        request,
        target,
        options=(),
        channel_credentials=None,
