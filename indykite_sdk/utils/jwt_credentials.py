...
from indykite_sdk.indykite.trusted_data.access.v1beta1 import trusted_data_access_api_pb2_grpc as tda_pb2_grpc
...
def get_credentials(client="identity", token_source=None):
    ...
    try:
        ...
        if client == "config":
            ...
            stub = tda_pb2_grpc.TrustedDataControlAPIStub(channel=channel)
        else:
