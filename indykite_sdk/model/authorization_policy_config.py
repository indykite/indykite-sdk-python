...
class AuthorizationPolicyConfig:
    ...
    def deserialize(cls, message_config):
        ...
        authorization_policy_config = AuthorizationPolicyConfig(policy=json.loads(message_config.policy))
        if "status" in fields:
        ...
        if "tags" in fields:
            authorization_policy_config.tags = [str(t) for t in message_config.tags]
