...
def read_service_account_credential(self, service_account_credential_id):
    ...
    try:
        response = self.stub.ReadServiceAccountCredential(
            pb2.ReadServiceAccountCredentialRequest(id=str(service_account_credential_id)),
        )
...
def register_service_account_credential_jwk(
    self,
    service_account_id,
    display_name,
    jwk_in_bytes,
...
def register_service_account_credential_pem(
    self,
    service_account_id,
    display_name,
    pem_in_bytes,
...
def delete_service_account_credential(self, service_account_credential_id, etag):
